...
export function Hero() {
  return (
    <section id="top" className="relative bg-background pb-20 sm:pb-24">
      <div className="px-3 pt-3 sm:px-4 sm:pt-4">
        <motion.div
          variants={staggerParent}
          initial="hidden"
          animate="visible"
          className="relative mx-auto max-w-[1500px] rounded-[2rem] bg-white px-5 pb-14 pt-24 text-ink sm:rounded-[3rem] sm:px-10 sm:pb-16 sm:pt-28 lg:pt-32"
        >
          ...
          <motion.h1
            variants={fadeUp}
            className="mx-auto max-w-4xl text-balance text-center font-heading text-[2rem] font-semibold leading-[1.06] sm:text-[2.625rem] lg:text-[3.125rem] xl:text-[3.75rem]"
          >
          ...
          <motion.p
            variants={fadeUp}
            className="mx-auto mt-5 max-w-2xl text-center text-base leading-relaxed text-neutral-600 sm:text-lg"
          >
            {hero.intro}
          </motion.p>
          ...
          <motion.div
            variants={fadeUp}
            className="mt-5 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-sm text-neutral-500"
          >
