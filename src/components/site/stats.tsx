...
function StatItem({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-white/50 sm:text-base">{label}</p>
    </motion.div>
  );
}
...
export function Stats() {
  return (
    <section className="relative px-4 sm:px-6 lg:px-10">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-2 divide-white/10 rounded-[1.75rem] bg-white/[0.03] ring-1 ring-white/10 sm:rounded-full lg:grid-cols-4 lg:divide-x">
